...
class ResultRepository(
    ...
    private suspend fun deviceWindow(): Window? {
        ...
        return buildWindow(locked, calls, sms, vector.labelDate, zone, vector.values, commsIncluded)
    }

    private fun demoWindow(): Window {
        val demo = DemoTraceSource(context).load()
        ...
        return buildWindow(
            demo.lockedIntervals, demo.calls, demo.sms, demo.labelDate, zone, vector.values, true,
        )
    }
